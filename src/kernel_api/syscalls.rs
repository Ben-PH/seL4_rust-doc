...
pub trait Syscall {
    ...
    fn send(reciever: CapPtr, msg: MessageInfo) {
        unimplemented!()
    }
    ...
    fn nb_send(reciever: CapPtr, msg: MessageInfo) {
        unimplemented!()
    }
    ...
    fn recv(endpoint: CapPtr, get_badge: bool) -> (MessageInfo, Option<Badge>) {
        unimplemented!()
    }

    /// As with `recv`, but does not block.
    fn nb_recv(endpoint: CapPtr, get_badge: bool) -> (MessageInfo, Option<Badge>) {
        unimplemented!()
    }
    ...
    fn call(invoked_cap: CapPtr, info: MessageInfo) -> SysResult {
        unimplemented!()
    }
