...
#[cfg(doc)]
#[cfg(doc)]
use crate::types::capabilities::{Capability, ThreadControlBlock, Notification, EndPoint, Reply };
use crate::types::{Badge, MessageInfo};
...
pub trait SeL4Recv: Capability {
    ...
    fn recv(&self, get_badge: bool) -> (MessageInfo, Option<Badge>);

    /// As with `recv`, but does not block.
    fn nb_recv(&self, get_badge: bool) -> (MessageInfo, Option<Badge>);
...
pub trait SeL4SendRecv: SeL4Send + SeL4Recv {
    ...
    fn call(&self, info: MessageInfo) -> SysResult;
